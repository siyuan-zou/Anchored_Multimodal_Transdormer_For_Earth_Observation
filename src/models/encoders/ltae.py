...
class LTAE2d(nn.Module):
    ...
    def forward(self, x, batch_positions=None, pad_mask=None):
        ...
        # print(out.shape) # torch.Size([1152, 50, 10])
        ...
        # print(out.shape) # torch.Size([1152, 50, 256])
        ...
        # print(out.shape) # torch.Size([16, 1152, 16])
        ...
        out = out.view(sz_b, -1)
        # print(out.shape) # torch.Size([32, 256, 6, 6])

        # if torch.isnan(out).any():
        #     print(f"Warning: out contains NaN values")
        #     print(out)
...
class LTAE2dPastis(nn.Module):
    ...
    def forward(self, x, batch_positions=None, pad_mask=None):
        ...
        return out.permute(0, 2, 1) # sz_b, seq_len